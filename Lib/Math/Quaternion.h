...
namespace math {
    ...
    /**
     * @class Quaternion
     * @brief A quaternion class that extends Vector for 3D rotations.
     * 
     * This class represents quaternions as 4D vectors [w, x, y, z] where:
    ...
    public:
         ...
         *
         * @param v The 4D vector to convert [w, x, y, z].
         ...
         */
        [[nodiscard]] double w() const { return at(0); }

        /**
         * @brief Get the x component.
         * @return The x component of the quaternion.
         */
        [[nodiscard]] double x() const { return at(1); }

        /**
         * @brief Get the y component.
         * @return The y component of the quaternion.
         */
        [[nodiscard]] double y() const { return at(2); }

        /**
         * @brief Get the z component.
         * @return The z component of the quaternion.
         */
        [[nodiscard]] double z() const { return at(3); }
         ...
         */
        Matrix<double> toRotationMatrix3x3() const;
         ...
         * @note Quaternion should be normalized for correct results.
         */
        Matrix<double> toRotationMatrix4x4() const;
         ...
         */
        static Quaternion fromRotationMatrix(const Matrix<double>& matrix);
